...
namespace QLCafe.DAL
{
    public class TableCoffeesRepository : BaseRepository, ITableCoffeesRepository
    {
        ...
        #region Xóa bàn
        public int TableCoffeesDelete(int Id)
        {
            DynamicParameters parameters = new DynamicParameters();
            parameters.Add("@Id", Id);
            var result = SqlMapper.ExecuteScalar<int>(con, "TableCoffees_Delete", parameters, commandType: CommandType.StoredProcedure);
            return result;
        }
        #endregion
        ...
        #region LẤY DANH SÁCH BÀN ĐÃ ĐẶT
